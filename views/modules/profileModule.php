			...
			<form class="formAjax form-horizontal" action="" method="POST" id="formSettings">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="location" id="location" value="<?php echo stripslashes( $this->infoSession->location ) ?>" class="form-control input-sm" placeholder="<?php echo $_SESSION['LANG']['location']; ?>">
			    </div>
			  </div><!-- **** form-group **** -->
